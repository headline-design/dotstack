...
import {
  ...
  CardHeader,
  CardTitle,
} from "@/dotstack-app/components/ui/card";
import { IconShield, IconSignout } from "@/dotstack-app/icons";
import { shorten, truncateMicroString } from "@/dotstack-app/lib/utils";

const SIWSDetails = ({ user, signOut }) => {
  return (
    <>
      {user?.wallets ? (
